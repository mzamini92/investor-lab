...
from global_etf_exposure_map.app.services.visualization import save_chart_bundle
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Analyze global ETF exposure.")
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    result = analyzer.analyze(_load_portfolio(args.portfolio)).to_dict()

    if args.save_charts:
        chart_paths = save_chart_bundle(result, args.output_dir)
        result["saved_charts"] = chart_paths
