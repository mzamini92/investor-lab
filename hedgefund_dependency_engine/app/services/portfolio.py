...
from hedgefund_dependency_engine.app.models import ETFHoldings, PortfolioPosition
from hedgefund_dependency_engine.app.utils.normalization import normalize_portfolio_weights


def build_constituent_frame(positions: list[PortfolioPosition], holdings_map: dict[str, ETFHoldings]) -> pd.DataFrame:
            ...
            rows.append(
                {
                    ...
                    "company_exposure": fund_weight * holding.holding_weight,
    ...
    frame["exposure"] = frame["company_exposure"]
    return frame
